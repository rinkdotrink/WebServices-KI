...
import de.ki.learn.cal2.DecisionTree;
...
public class DecisionTreeTest {
	...
	public final void testDoConceptDoNotMatches(){
		...
		assertEquals("Vorfahrt gewähren", decisionTree.getNexts().get(0).getConcept());
	...
	public final void testNr3(){
		...
		assertEquals("Vorfahrt von Rechts", decisionTree.getNexts().get(1).getConcept());
	}
	...
	public final void testNr5(){
		...
		assertEquals("Fahrtrichtung links", decisionTree.getNexts().get(3).getConcept());
	}
	...
	public final void testNr6(){
		...
		assertEquals((long)10,(long) decisionTree.getNexts().get(3).getValues().get(0));
		assertEquals("node", decisionTree.getNexts().get(3).getConcept());
		
		assertEquals(rootExpected, decisionTree.getNexts().get(3).getNexts().get(0).getRoot());
		assertEquals(2, decisionTree.getNexts().get(3).getNexts().get(0).getPropertyIndex());
		assertEquals(true, decisionTree.getNexts().get(3).getNexts().get(0).isLeaf());
		assertEquals("Fahrtrichtung rechts", decisionTree.getNexts().get(3).getNexts().get(0).getConcept());
	}
	...
	public final void testNr7(){
		...
		assertEquals(rootExpected, decisionTree.getNexts().get(3).getNexts().get(0).getRoot());
		assertEquals(2, decisionTree.getNexts().get(3).getNexts().get(0).getPropertyIndex());
		assertEquals(false, decisionTree.getNexts().get(3).getNexts().get(0).isLeaf());
		assertEquals((long)0,(long) decisionTree.getNexts().get(3).getNexts().get(0).getValues().get(0));
		assertEquals("node", decisionTree.getNexts().get(3).getNexts().get(0).getConcept());
		
		assertEquals(rootExpected, decisionTree.getNexts().get(3).getNexts().get(0).getNexts().get(0).getRoot());
		assertEquals(3, decisionTree.getNexts().get(3).getNexts().get(0).getNexts().get(0).getPropertyIndex());
		assertEquals(true, decisionTree.getNexts().get(3).getNexts().get(0).getNexts().get(0).isLeaf());
		assertEquals("Fahrtrichtung links", decisionTree.getNexts().get(3).getNexts().get(0).getNexts().get(0).getConcept());
	}
	...
	public final void testNr8(){
		...
		assertEquals(rootExpected, decisionTree.getNexts().get(3).getNexts().get(0).getNexts().get(0).getRoot());
		assertEquals(3, decisionTree.getNexts().get(3).getNexts().get(0).getNexts().get(0).getPropertyIndex());
		assertEquals(false, decisionTree.getNexts().get(3).getNexts().get(0).getNexts().get(0).isLeaf());
		assertEquals((long)30,(long) decisionTree.getNexts().get(3).getNexts().get(0).getNexts().get(0).getValues().get(0));		
		assertEquals("node", decisionTree.getNexts().get(3).getNexts().get(0).getNexts().get(0).getConcept());
		
		assertEquals(rootExpected, decisionTree.getNexts().get(3).getNexts().get(0).getNexts().get(0).getNexts().get(0).getRoot());
		assertEquals(4, decisionTree.getNexts().get(3).getNexts().get(0).getNexts().get(0).getNexts().get(0).getPropertyIndex());
		assertEquals(true, decisionTree.getNexts().get(3).getNexts().get(0).getNexts().get(0).getNexts().get(0).isLeaf());
		assertEquals("Fahrtrichtung rechts", decisionTree.getNexts().get(3).getNexts().get(0).getNexts().get(0).getNexts().get(0).getConcept());
	}
	...
	public final void testNr9(){
		...
		assertEquals(rootExpected, decisionTree.getNexts().get(3).getNexts().get(0).getNexts().get(0).getNexts().get(0).getRoot());
		assertEquals(4, decisionTree.getNexts().get(3).getNexts().get(0).getNexts().get(0).getNexts().get(0).getPropertyIndex());
		assertEquals(false, decisionTree.getNexts().get(3).getNexts().get(0).getNexts().get(0).getNexts().get(0).isLeaf());
		assertEquals((long)40,(long) decisionTree.getNexts().get(3).getNexts().get(0).getNexts().get(0).getNexts().get(0).getValues().get(0));
		assertEquals("node", decisionTree.getNexts().get(3).getNexts().get(0).getNexts().get(0).getNexts().get(0).getConcept());
		
		assertEquals(rootExpected, decisionTree.getNexts().get(3).getNexts().get(0).getNexts().get(0).getNexts().get(0).getNexts().get(0).getRoot());
		assertEquals(5, decisionTree.getNexts().get(3).getNexts().get(0).getNexts().get(0).getNexts().get(0).getNexts().get(0).getPropertyIndex());
		assertEquals(true, decisionTree.getNexts().get(3).getNexts().get(0).getNexts().get(0).getNexts().get(0).getNexts().get(0).isLeaf());
		assertEquals("Fahrtrichtung links", decisionTree.getNexts().get(3).getNexts().get(0).getNexts().get(0).getNexts().get(0).getNexts().get(0).getConcept());
	}
	...
	public final void testNr10(){
		...
		assertEquals(rootExpected, decisionTree.getNexts().get(3).getNexts().get(0).getNexts().get(0).getNexts().get(0).getNexts().get(1).getRoot());
		assertEquals(5, decisionTree.getNexts().get(3).getNexts().get(0).getNexts().get(0).getNexts().get(0).getNexts().get(1).getPropertyIndex());
		assertEquals(true, decisionTree.getNexts().get(3).getNexts().get(0).getNexts().get(0).getNexts().get(0).getNexts().get(1).isLeaf());
		assertEquals("Fahrtrichtung rechts", decisionTree.getNexts().get(3).getNexts().get(0).getNexts().get(0).getNexts().get(0).getNexts().get(1).getConcept());
	}
	...
	public final void testNr11(){
		...
		assertEquals(rootExpected, decisionTree.getNexts().get(3).getNexts().get(1).getRoot());
		assertEquals(2, decisionTree.getNexts().get(3).getNexts().get(1).getPropertyIndex());
		assertEquals(true, decisionTree.getNexts().get(3).getNexts().get(1).isLeaf());
		assertEquals("Vorfahrtsstraße", decisionTree.getNexts().get(3).getNexts().get(1).getConcept());
	...
	public void test1_classify(){
		...
		test1();
		DecisionTree decTreeResult = decisionTree.classify(decisionTree, propAndCon);
